...
public class Server {
    ...
    public Table findSeat(Player player) throws ClassNotFoundException, IOException {
        ...
        newTable.BlackjackGame(); // We may want to consider starting this on a separate thread
        tables.add(newTable);
        return newTable;
    }
    ...
    public static void main(String[] args) {
    	...
    	// ServerSocket serverSocket = null; // declare outside so we can avoid a resource leak
    	try {
        	...
        	// We have a resource leak, consider declaring serverSocket outside of the try block 
        	// and assigning it inside of the try block
        	// serverSocket.close();
        }
    }
}